 ...
 *
 * <p>This is intended to generally store {@link com.google.bitcoin.core.StoredBlock}s
 * with full sets of transactions, by contrast to an implementation of
 * {@link com.google.bitcoin.store.AbstractSqlPrunedBlockStore}.</p>
 */
public abstract class AbstractSqlBlockStore implements BatchableBlockStore {
  ...
  @Override
  public abstract void abortBatchWrite() throws BlockStoreException;
