...
/**
 * Implementors can be connected to a {@link SPVBlockChain} and have its methods called when various things
...
public interface BlockChainListener {
    /**
     * <p>Called by the {@link SPVBlockChain} when a new block on the best chain is seen, AFTER relevant
    ...
    /**
     * Called by the {@link SPVBlockChain} when the best chain (representing total work done) has changed. In this case,
     ...
     * be provided via the receiveFromBlock method. This method is essentially an optimization that lets SPVBlockChain
